...
<template>
  <Dialog v-model:visible="showNotAuthModal" modal header="Это платный урок" class="w-[90%] md:w-[50%]">
    ...
    <div class="flex justify-end gap-2">
      ...
      <Button @click="navigateTo('/auth?form=register')" type="button" label="Зарегистрироваться"/>
      <Button  @click="navigateTo('/auth?form=login')" outlined type="button" label="Войти"/>
    </div>
  </Dialog>
</template>
