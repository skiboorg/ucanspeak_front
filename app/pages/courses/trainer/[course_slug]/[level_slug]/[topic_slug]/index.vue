    ...
    <div class="col-span-12 md:col-span-4">
      <CardBase padding="sm" class="space-y-3">
        ...
        <div
            ...
            class="hidden md:block cursor-pointer border border-[#E8E8E9] px-5 py-4 rounded-3xl"
        ...
        <div @click="openTest" class="cursor-pointer border border-[#E8E8E9] px-5 py-4 rounded-3xl"
